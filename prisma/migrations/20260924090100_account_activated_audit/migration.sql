-- ACCOUNT_ACTIVATED: an imported account coming to life.
--
-- Its own migration rather than an edit to 20260924090000, which is already
-- recorded as applied — "prisma migrate deploy" verifies each recorded
-- migration's checksum before running anything, so editing an applied file
-- makes the whole deploy refuse to start.
--
